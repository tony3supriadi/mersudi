...
document.addEventListener('DOMContentLoaded', function (e) {
  (function () {
    ...
    if (typeof stepsValidation !== undefined && stepsValidation !== null) {
      ...
      // Form steps
      const stepsValidationFormStep1 = stepsValidationForm.querySelector('#personalDataInfoValidatoin');
      const stepsValidationFormStep2 = stepsValidationForm.querySelector('#memberDataInfoValidatoin');
      const stepsValidationFormStep3 = stepsValidationForm.querySelector('#memberCardValidation');
