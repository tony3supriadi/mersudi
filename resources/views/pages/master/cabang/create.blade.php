...
@section('title', 'Cabang - Tambah Baru')
...
@section('content')
    <h4 class="content-header-title">
        ...
        <span class="text-muted fw-light">Cabang /</span> Tambah Baru
    </h4>

    <div class="row">
        <div class="col-xxl-6 col-md-8 col-12">
            <div class="card">
                <form action="{{ route('master.cabang.store') }}" id="form-submit" method="post">
                    @csrf
                ...
                if (response.status == "success") {
                    switch (redirect) {
                        case 'new':
                            ...
                            break;
                        case 'edit':
                            window.location.href = `{{ route('master.cabang.index') }}/${response.data.id}/edit`;
                            break;
                        default:
