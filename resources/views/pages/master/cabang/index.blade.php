...
<div class="row g-4 mb-2 text-secondary">
    <div class="col-md-12 d-flex align-items-center">
        ...
        <div class="d-inline-block w-px-200">
            <select name="pengda" class="form-select select2">
                <option value=""></option>
...
<form action="{{ route('master.cabang.destroy') }}" method="POST" id="delete-submit" class="d-none">
    @csrf
    @method('delete')
        ...
        var table = $('.datatable').DataTable({
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    if (row.id > 1) {
                        return (`
                            @canany(['master-cabang-update', 'master-cabang-delete'])
                                <div class="d-inline-flex">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="{{ route('master.cabang.index') }}/${row.id}" class="dropdown-item">
                                            <span class="ti ti-eye"></span> Detail
                                        </a>

                                        @can('master-cabang-update')
                                            <a href="{{ route('master.cabang.index') }}/${row.id}/edit" class="dropdown-item">
                                                <span class="ti ti-edit"></span> Ubah
                                            </a>
                                        @endcan

                                        @can('master-cabang-delete')
