...
@section('content')
<h4 class="mb-3">Daftar Daerah</h4>
...
<form action="{{ route('master.daerah.destroy') }}" method="POST" id="delete-submit" class="d-none">
    @csrf
    @method('delete')
            ...
            buttons: [
                @can('master-daerah-create')
                {
                    ...
                    action: (e, dt, button, config) => {
                        window.location = "{{ route('master.daerah.create') }}"
                    }
                },
                {
                    // Mobile
