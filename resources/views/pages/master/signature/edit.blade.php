...
@section('title', 'Signature - Ubah Data')
...
@section('content')
    <h4 class="content-header-title">
        ...
        <span class="text-muted fw-light">Signature /</span> Ubah Data
    </h4>

    <div class="row">
        <div class="col-xxl-6 col-md-8 col-12">
            <div class="card">
                <form action="{{ route('master.signature.update', $signature->id) }}" id="form-submit" method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group mb-2" data-field="nama">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ $signature->nama }}" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group mb-2" data-field="jabatan">
                                ...
                                <input type="text" name="jabatan" id="jabatan" value="{{ $signature->jabatan }}" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group mb-2" data-field="signature">
                                ...
                                <img src="{{ asset('storage/signature/' . $signature->signature) }}" alt="" width="200" class="mt-3" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group mb-2" data-field="keterangan">
                                ...
                                <textarea name="keterangan" id="keterangan" class="form-control">{{ $signature->keterangan }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="aktif" id="aktif" @if ($signature->aktif) checked @endif value="1" />
