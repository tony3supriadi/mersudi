...
@section('title', 'Daftar Paket KTA')

@section('content')
<h4 class="mb-3">Daftar Paket KTA</h4>
...
<form action="{{ route('master.kta.destroy') }}" method="POST" id="delete-submit" class="d-none">
    @csrf
    @method('delete')
    ...
    $(function() {
        $('.datatable').DataTable({
            ...
            columns: [{
                ...
                render: (data, type, row, meta) => {
                    return (`
                        @canany(['master-kta-update', 'master-kta-delete'])
                            <div class="d-inline-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ route('master.kta.index') }}/${row.id}" class="dropdown-item">
                                        <span class="ti ti-eye"></span> Detail
                                    </a>

                                    @can('master-kta-update')
                                        <a href="{{ route('master.kta.index') }}/${row.id}/edit" class="dropdown-item">
                                            <span class="ti ti-edit"></span> Ubah
                                        </a>
                                    @endcan

                                    @can('master-kta-delete')
