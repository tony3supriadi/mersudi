                ...
                <div class="w-px-700">
                    <div id="multiStepsValidation" class="bs-stepper shadow-none">
                        <div class="bs-stepper-header border-bottom-0">
                            <div class="step" data-target="#personalDataInfoValidatoin">
                                <button type="button" class="step-trigger">
                                    <span class="bs-stepper-circle"><i class="ti ti-circle ti-sm"></i></span>
                            ...
                            <div class="step" data-target="#memberDataInfoValidatoin">
                                <button type="button" class="step-trigger">
                            ...
                            <div class="step" data-target="#memberCardValidation">
                                <button type="button" class="step-trigger">
                        ...
                        <div class="bs-stepper-content">
                            <form id="multiStepsForm" onSubmit="return false">
                                <!-- Informasi Personal -->
                                <div id="personalDataInfoValidatoin" class="content">
                                    <div class="content-header mb-4">
                                        <h3 class="mb-1">Informasi Personal</h3>
                                        <p>Masukan data informasi personal Anda:</p>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                ...
                                <!-- Personal Info -->
                                <div id="memberDataInfoValidatoin" class="content">
                                    <div class="content-header mb-4">
                                ...
                                <!-- Billing Links -->
                                <div id="memberCardValidation" class="content">
