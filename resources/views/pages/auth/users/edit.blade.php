...
@section('content')
    <h4 class="content-header-title">
        ...
        <span class="text-muted fw-light">Users /</span> Ubah Data
    </h4>

    <div class="row">
        <div class="col-xxl-6 col-lg-8 col-12">
            <div class="card">
                <form action="{{ route('users.update', $user->id) }}" id="form-submit" method="post">
                    @csrf
                    @method('PUT')
                                ...
                                @foreach ($roles as $role)
                                    <div class="col-md-6 col-lg-4 py-1">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="{{ $role->name }}" name="roles[]" id="role-{{ $role->id }}" @if(in_array($role->id, $userRoles)) checked @endif />
