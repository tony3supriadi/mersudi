...
@section('content')
    <h4 class="content-header-title">
        ...
        <span class="text-muted fw-light">Roles /</span> Tambah Baru
    </h4>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($permissions as $permission)
                                        <tr>
                                            <td>
                                                <div class="form-check">
                                                    <input type="checkbox" id="permissions-{{ $permission->id }}" name="permissions[]" value="{{ $permission->name }}" class="form-check-input form-check-roles-item" />
                                                ...
                                                @foreach ($permission->actions as $action)
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input type="checkbox" name="permissions[]" value="{{ $action->name }}" class="form-check-input form-check-roles-item" />
                                                        </div>
                                                    </td>
                                                @endforeach
                                            @else
